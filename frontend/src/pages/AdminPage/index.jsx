...
const AdminLogin = () => {
  ...
  // Triple-tap detection using Date.now()
  ...
  const handlePlayButtonClick = () => {
    ...
    setTimeout(() => {
      console.log('✅ Verification complete. Navigating to admin page...');
      setIsPlaying(false);
      setShowCassetteOverlay(false);
      window.location.href = '/admin'; // ✅ Redirects to admin page
    }, 3000);
  };
