...
const LsConcernPage = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        // ✅ Updated to use 'lsconcern' category (matches VALID_CATEGORIES in API)
        ...
        console.log('🔍 Legal & Social API Response:', data);
        ...
        console.error('❌ Error fetching legal & social blogs:', err);
  ...
  const handlePostClick = (post) => {
    navigate(`/blog/lsconcern/${post.id}`); // ✅ Updated to unified route format
  };
