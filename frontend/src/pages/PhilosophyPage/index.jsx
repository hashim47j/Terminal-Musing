...
const DynamicBackgroundShadow = ({ darkMode }) => {
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  if (navigator.share) {
                    ...
                    navigator.clipboard.writeText(`${window.location.origin}/blog/philosophy/${post.id}`);
...
const PhilosophyPage = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        const res = await fetch('/api/blogs/philosophy');
  ...
  const handlePostClick = (post) => {
    navigate(`/blog/philosophy/${post.id}`);
  };
